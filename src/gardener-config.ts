...
export const DEFAULT_GARDENER_CONFIG: StackGardenerConfig = {
  ...
  tools: {
    allow: [
      ...
      "stack_get_optimizer_startup_catalog",
      "stack_audit_online_reflexion_receipt",
      "stack_audit_online_reflexion_receipts",
      "stack_validate_online_reflexion_evidence_notes",
