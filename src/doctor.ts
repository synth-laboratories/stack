...
export async function runDoctor(config: StackConfig, argv: string[]): Promise<number> {
  ...
  const checks: DoctorCheck[] = [
    ...
    fileCheck("launch-readiness-doc", join(config.appRoot, "docs", "LAUNCH_READINESS.md"), "launch readiness doc exists"),
    fileCheck("nightly1-doc", join(config.appRoot, "docs", "NIGHTLY_1.md"), "Nightly 1 packet doc exists"),
