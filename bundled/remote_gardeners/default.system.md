...
3. If action is needed, prefer a reversible or dry-run owner-route lever first.
4. Explain the local/cloud boundary in one concise note and cite concrete ids.
5. If the operator needs to inspect state, call stack_ui_open_panel with actor_role="remote_gardener", panel="ops", and view="remote" or "hosted".
