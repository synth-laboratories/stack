...
const gates: Gate[] = [
  gate("S0_SCOPE", "AT-STACK-SCOPE-001", "Jstack", docsExist(["CHANGELOG.md", "docs/RELEASE.md", "docs/QUALITY.md", "docs/LAUNCH_READINESS.md", "docs/NIGHTLY_1.md"]),
    "Launch scope, channel model, quality guide, and changelog files exist.",
    "CHANGELOG.md, docs/RELEASE.md, docs/QUALITY.md, docs/LAUNCH_READINESS.md, docs/NIGHTLY_1.md",
    "Keep channel/non-goals updated in the Jstack ship record before external amplification."),
  ...
  gate("S8_DOCS_CHANGELOG", "AT-STACK-DOCS-CHANGELOG-001", "stack+docs", docsAlignmentStatus(),
    ...
    docsAlignmentStatus() === "pass"
      ...
      : "README.md, CHANGELOG.md, docs/RELEASE.md, docs/QUALITY.md, docs/LAUNCH_READINESS.md, docs/DISTRIBUTION.md, docs/TELEMETRY.md, docs/NIGHTLY_1.md",
    docsAlignmentStatus() === "pass"
...
function distributionStatus(): Status {
  ...
  if (existsSync(join(stackRoot, "docs", "DISTRIBUTION.md")) && existsSync(join(stackRoot, "docs", "NIGHTLY_1.md"))) return "partial"
...
function docsAlignmentStatus(): Status {
  return docsExist(["README.md", "CHANGELOG.md", "docs/RELEASE.md", "docs/QUALITY.md", "docs/LAUNCH_READINESS.md", "docs/DISTRIBUTION.md", "docs/TELEMETRY.md", "docs/NIGHTLY_1.md"]) === "pass"
