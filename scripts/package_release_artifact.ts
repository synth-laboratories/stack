...
writeLauncher("stack", [
  ...
  'STACK_ROOT_DIR="$(cd "$STACK_LAUNCHER_DIR/.." && pwd)"',
  ...
  "  fi",
  "",
  '  mkdir -p "$APP_ROOT/.stack/runtime"',
  '  nohup "$STACK_ROOT_DIR/bin/stackd" serve </dev/null >"$APP_ROOT/.stack/runtime/stackd.log" 2>&1 &',
